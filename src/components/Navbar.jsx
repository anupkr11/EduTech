      ...
      <nav className="fixed w-full top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-gray-200 shadow-sm">
        <div className="w-full px-4 sm:px-6 lg:px-10 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link to="/" className="text-gray-700 hover:text-blue-600 transition text-lg font-medium">
              Home
            </Link>

            <Link to="/courses" className="text-gray-700 hover:text-blue-600 transition text-lg font-medium">
              Courses
            </Link>

            {isAuthenticated ? (
              <>
                <Link to="/dashboard" className="text-gray-700 hover:text-blue-600 transition text-lg font-medium">
                  Dashboard
                </Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden px-6 pb-4 space-y-4 bg-white shadow">
            ...
            {isAuthenticated ? (
              ...
              <button onClick={() => setIsLoginOpen(true)} className="w-full bg-blue-600 text-white py-2 rounded-lg">
                Login
              </button>
            )}
          </div>
